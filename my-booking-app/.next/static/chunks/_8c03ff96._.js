        ...
        "Navbar.useEffect": ()=>{
            ...
            ({
                "Navbar.useEffect": async ()=>{
                    ...
                    const mein = list.find({
                        "Navbar.useEffect.mein": (s)=>s.name === 'Mein Salon'
                    }["Navbar.useEffect.mein"]);
                    const first = list[0];
                    let id = stored && list.some({
                        "Navbar.useEffect": (s)=>s._id === stored
                    }["Navbar.useEffect"]) ? stored : null;
...
_s(Navbar, "1WH8x0TYgmRUvvUURsa28L/68Po=", false, function() {
    return [
...
//# sourceMappingURL=_8c03ff96._.js.map