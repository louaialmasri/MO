...
function AdminSalonsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminSalonsPage.useEffect": ()=>{
            if (!user) return router.replace('/login');
            if (user.role !== 'admin') return router.replace('/');
            ({
                "AdminSalonsPage.useEffect": async ()=>setSalons(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchSalons"])())
            })["AdminSalonsPage.useEffect"]();
        }
    }["AdminSalonsPage.useEffect"], [
        user
    ...
    const createSalon = async ()=>{
        ...
        try {
            const salon = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSalonApi"])({
                name,
    ...
    const doDelete = async ()=>{
        if (!confirmId) return;
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteSalonApi"])(confirmId);
...
_s(AdminSalonsPage, "jw4AcPiE2mUKc5xaen1DEK1WxuA=", false, function() {
    return [
...
_c = AdminSalonsPage;
var _c;
__turbopack_context__.k.register(_c, "AdminSalonsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_fc826e7b._.js.map