...
function LoginPage() {
    ...
    const handleLogin = async ()=>{
        setError('');
        try {
            const { token, user } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(email, password);
...
//# sourceMappingURL=_8065fe4f._.js.map