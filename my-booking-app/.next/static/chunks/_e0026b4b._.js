...
"[project]/app/admin/availability/templates/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function TemplatesPage() {
    ...
    const selected = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TemplatesPage.useMemo[selected]": ()=>templates.find({
                "TemplatesPage.useMemo[selected]": (t)=>t._id === selectedId
            }["TemplatesPage.useMemo[selected]"]) || null
    }["TemplatesPage.useMemo[selected]"], [
        templates,
        selectedId
    ]);
    const [days, setDays] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(emptyWeek());
    const [tplName, setTplName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    // apply
    const [weekStart, setWeekStart] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('') // yyyy-mm-dd (Montag)
    ;
    const [weeks, setWeeks] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    const [replace, setReplace] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TemplatesPage.useEffect": ()=>{
            ({
                "TemplatesPage.useEffect": async ()=>{
                    if (!salonId) return;
                    const st = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listStaffAssignmentsForSalon"])(salonId);
                    setStaff(st.map({
                        "TemplatesPage.useEffect": (u)=>({
                                _id: u._id,
                                name: u.name,
                                email: u.email
                            })
        ...
        "TemplatesPage.useEffect": ()=>{
            ({
                "TemplatesPage.useEffect": async ()=>{
                    ...
                    const list = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchTemplates"])(staffId);
                    setTemplates(list);
                    if (list[0]?._id) {
    ...
    const saveTemplate = async ()=>{
        try {
            ...
            if (selected) {
                const upd = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateTemplateApi"])(selected._id, {
                    name: tplName.trim(),
                    days
                });
                ...
                const created = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createTemplateApi"])({
                    name: tplName.trim(),
                    staff: staffId,
                    days
                });
    ...
    const removeTemplate = async (id)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteTemplateApi"])(id);
    ...
    const applyNow = async ()=>{
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyTemplateApi"])({
...
_s(TemplatesPage, "wpEydWNeBXYlP2y4v3ISNZWTMTY=", false, function() {
    return [
...
//# sourceMappingURL=_e0026b4b._.js.map