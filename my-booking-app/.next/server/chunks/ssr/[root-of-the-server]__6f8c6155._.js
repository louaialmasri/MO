...
const AuthProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const axios = __turbopack_context__.r("[project]/node_modules/axios/dist/node/axios.cjs [app-ssr] (ecmascript)").default || __turbopack_context__.r("[project]/node_modules/axios/dist/node/axios.cjs [app-ssr] (ecmascript)");
...
{
__turbopack_context__.s({
    "applyTemplateApi": (()=>applyTemplateApi),
    "assignServiceToSalon": (()=>assignServiceToSalon),
    "assignStaffToSalon": (()=>assignStaffToSalon),
    "createAvailabilityApi": (()=>createAvailabilityApi),
    "createBooking": (()=>createBooking),
    "createGlobalService": (()=>createGlobalService),
    "createGlobalStaff": (()=>createGlobalStaff),
    "createSalonApi": (()=>createSalonApi),
    "createService": (()=>createService),
    "createTemplateApi": (()=>createTemplateApi),
    "createUserManually": (()=>createUserManually),
    "deleteAvailabilityApi": (()=>deleteAvailabilityApi),
    "deleteBooking": (()=>deleteBooking),
    "deleteGlobalService": (()=>deleteGlobalService),
    "deleteGlobalUser": (()=>deleteGlobalUser),
    "deleteSalonApi": (()=>deleteSalonApi),
    "deleteServiceById": (()=>deleteServiceById),
    "deleteTemplateApi": (()=>deleteTemplateApi),
    "deleteUserById": (()=>deleteUserById),
    "fetchAllUsers": (()=>fetchAllUsers),
    "fetchGlobalServices": (()=>fetchGlobalServices),
    "fetchGlobalStaff": (()=>fetchGlobalStaff),
    "fetchSalons": (()=>fetchSalons),
    "fetchSalonsWithGuards": (()=>fetchSalonsWithGuards),
    ...
    "listServiceAssignmentsForSalon": (()=>listServiceAssignmentsForSalon),
    "listStaffAssignmentsForSalon": (()=>listStaffAssignmentsForSalon),
    "login": (()=>login),
    "register": (()=>register),
    "unassignServiceFromSalon": (()=>unassignServiceFromSalon),
    "unassignStaffFromSalon": (()=>unassignStaffFromSalon),
    ...
    "updateTemplateApi": (()=>updateTemplateApi),
...
api.interceptors.request.use((config)=>{
    ...
    if (!config.noSalonHeader) {
        const salonId = localStorage.getItem('activeSalonId');
        if (salonId) config.headers['x-salon-id'] = salonId;
    }
    return config;
});
...
async function createUserManually(email, password, name, address, phone, role = 'user', token) {
...
async function deleteSalonApi(id) {
    const res = await api.delete(`/salons/${id}`);
    return res.data;
}
async function fetchGlobalStaff() {
    const res = await api.get('/admin/staff-all', {});
    res.config.noSalonHeader = true;
    return res.data.users;
}
async function fetchGlobalServices() {
    const res = await api.get('/admin/services-all', {});
    res.config.noSalonHeader = true;
    return res.data.services;
}
async function listStaffAssignmentsForSalon(salonId) {
...
async function assignStaffToSalon(staffId, salonId) {
    const res = await api.post('/assignments/staff', {
        staffId,
        salonId
    });
    return res.data.assignment;
}
async function unassignStaffFromSalon(staffId, salonId) {
    const res = await api.delete('/assignments/staff', {
        data: {
            staffId,
            salonId
        }
...
async function listServiceAssignmentsForSalon(salonId) {
    const res = await api.get('/assignments/services', {
        params: {
            salonId
        }
    });
...
async function assignServiceToSalon(payload) {
    const res = await api.post('/assignments/services', payload);
    return res.data.assignment;
}
async function unassignServiceFromSalon(serviceId, salonId) {
    const res = await api.delete('/assignments/services', {
        data: {
            serviceId,
            salonId
        }
...
async function updateGlobalService(id, payload) {
    const config = {};
    config.noSalonHeader = true; // Wichtig für globale Admin-Funktionen
    const res = await api.patch(`/admin/services/${id}`, payload, config);
    return res.data.service;
}
async function fetchSalonsWithGuards() {
    const config = {};
    config.noSalonHeader = true;
    const res = await api.get('/salons/guards', config);
    return res.data.salons;
}
async function fetchTemplates(staffId) {
    const res = await api.get('/availability-templates', {
        params: staffId ? {
            staffId
        } : {}
    });
...
async function createTemplateApi(payload) {
...
async function applyTemplateApi(payload) {
...
function Navbar() {
    ...
    const isMobile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$useMediaQuery$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__useMediaQuery$3e$__["useMediaQuery"])('(max-width:899px)', {
        noSsr: true
    });
    ...
    const [salonEl, setSalonEl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$AppBar$2f$AppBar$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__AppBar$3e$__["AppBar"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Container$2f$Container$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Container$3e$__["Container"], {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Toolbar$2f$Toolbar$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Toolbar$3e$__["Toolbar"], {
                ...
                children: [
                    Brand,
                    hydrated && !isMobile && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                        sx: {
                            ml: 'auto',
                            display: 'flex',
                            gap: 1,
                        ...
                        children: [
                            ...
                            role === 'admin' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Button$2f$Button$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Button$3e$__["Button"], {
                                        color: "inherit",
                                        onClick: (e)=>setSalonEl(e.currentTarget),
                                        sx: {
                                            textTransform: 'none',
                                            px: 1.25
                                        },
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Stack$2f$Stack$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Stack$3e$__["Stack"], {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Avatar$2f$Avatar$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Avatar$3e$__["Avatar"], {
                                                    src: activeSalon?.logoUrl,
                                                    sx: {
                                                        width: 28,
                                                        height: 28,
                                                        fontSize: 14
                                                    },
                                                    children: (activeSalon?.name || 'S').slice(0, 2).toUpperCase()
                                                }, void 0, false, {
                                                    fileName: "[project]/components/Navbar.tsx",
                                                    lineNumber: 187,
                                                    columnNumber: 7
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                                    ...
                                                    children: activeSalon?.name || 'Mein Salon'
                                                }, void 0, false, {
                                                    fileName: "[project]/components/Navbar.tsx",
                                                    lineNumber: 190,
                                                    columnNumber: 7
                                                }, this),
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$icons$2d$material$2f$esm$2f$ArrowDropDown$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                                    fileName: "[project]/components/Navbar.tsx",
                                                    lineNumber: 191,
                                                    columnNumber: 7
                                                }, this)
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Menu$2f$Menu$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Menu$3e$__["Menu"], {
                                        ...
                                        children: [
                                            salons.map((s)=>{
                                                ...
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$MenuItem$2f$MenuItem$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__MenuItem$3e$__["MenuItem"], {
                                                    onClick: ()=>{
                                                        ...
                                                        try {
                                                            window.dispatchEvent(new CustomEvent('activeSalonChanged', {
                                                                detail: s._id
                                                            }));
                                                        } catch  {}
                                                        router.refresh?.();
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$MenuItem$2f$MenuItem$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__MenuItem$3e$__["MenuItem"], {
                                                ...
                                                children: "Abwesenheiten & Arbeitszeiten"
                                            }, void 0, false, {
                                                fileName: "[project]/components/Navbar.tsx",
                                                lineNumber: 218,
                                                columnNumber: 3
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$MenuItem$2f$MenuItem$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__MenuItem$3e$__["MenuItem"], {
                                                onClick: ()=>{
                                                    setSalonEl(null);
                                                    router.push('/admin/availability/templates');
                                                },
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$emotion$2f$server$2f$create$2d$instance$2f$dist$2f$emotion$2d$server$2d$create$2d$instance$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@emotion/server/create-instance/dist/emotion-server-create-instance.esm.js [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$theme$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/theme.ts [app-ssr] (ecmascript)"); // deinen bestehenden Theme-Pfad benutzen
'use client';
;
;
;
...
function ThemeRegistry({ children }) {
    const [{ cache, flush }] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>{
        ...
        const { extractCriticalToChunks } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$emotion$2f$server$2f$create$2d$instance$2f$dist$2f$emotion$2d$server$2d$create$2d$instance$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(cache);
        return {
            cache,
            flush () {
                const chunks = extractCriticalToChunks('');
                const styles = chunks.styles.map((style)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("style", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6f8c6155._.js.map