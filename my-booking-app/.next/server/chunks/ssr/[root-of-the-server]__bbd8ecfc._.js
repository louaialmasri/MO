...
function AdminPage() {
    ...
    .map((b)=>{
        ...
        return {
            id: b._id,
            title: `${service?.name} – ${b.user?.email ?? 'Unbekannt'} (Staff: ${b.staff?.email ?? '???'})`,
    ...
    const eventsByStaff = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        bookings.forEach((b)=>{
            ...
            map[staffId].push({
                id: b._id,
                title: `${b.service?.name ?? 'Service'} – ${typeof b.user === 'object' && b.user?.email ? b.user.email : String(b.user)}`,
                start: start.toISOString(),
                end: end.toISOString(),
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                            ...
                                            children: [
                                                ...
                                                " ",
                                                services.find((s)=>s._id === selectedBooking.serviceId)?.name || 'Unbekannt'
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/app/admin/page.tsx",
                                            lineNumber: 451,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bbd8ecfc._.js.map