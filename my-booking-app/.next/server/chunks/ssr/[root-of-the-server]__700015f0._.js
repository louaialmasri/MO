...
function registerUser(email, password) {
    ...
    const role = email === 'MO.com' ? 'admin' : 'user';
    users.push({
        id: userIdCounter++,
        email,
        password,
...
function getServices() {
    ...
    return services // Falls nichts gespeichert, Standard-Services
    ;
}
}}),
...
const AuthProvider = ({ children })=>{
    ...
    const login = (email)=>{
        const foundUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUserByEmail"])(email);
        setUser(email);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__700015f0._.js.map