...
function LoginPage() {
    ...
    const handleLogin = ()=>{
        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginUser"])(email, password);
        if (!result.success) {
            setError(result.message);
        } else {
            // 🔐 Temporär speichern wir den Login in localStorage
...
//# sourceMappingURL=%5Broot-of-the-server%5D__24a0017e._.js.map